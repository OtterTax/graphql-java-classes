...
public class F1098eInputStatement {
  ...
  public String toGraphql() {
    ...
    if(box1DoesNotIncludeFees != null) {
      sb.append("  box1DoesNotIncludeFees: " + gson.toJson(box1DoesNotIncludeFees) + "\n");
    }
    if(corrected != null) {
      sb.append("  corrected: " + gson.toJson(corrected) + "\n");
    }
    if(interestReceived != null) {
      sb.append("  interestReceived: " + gson.toJson(interestReceived) + "\n");
    }
