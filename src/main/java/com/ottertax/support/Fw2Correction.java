  ...
  public static class Statement {
    ...
    public String toGraphql() {
      ...
      if(allocatedTips != null) {
        sb.append("  allocatedTips: " + gson.toJson(allocatedTips) + "\n");
      }
      if(box12Amount1 != null) {
        sb.append("  box12Amount1: " + gson.toJson(box12Amount1) + "\n");
      }
      if(box12Amount2 != null) {
        sb.append("  box12Amount2: " + gson.toJson(box12Amount2) + "\n");
      }
      if(box12Amount3 != null) {
        sb.append("  box12Amount3: " + gson.toJson(box12Amount3) + "\n");
      }
      if(box12Amount4 != null) {
        sb.append("  box12Amount4: " + gson.toJson(box12Amount4) + "\n");
      }
      if(box12Code1 != null) {
        sb.append("  box12Code1: " + gson.toJson(box12Code1) + "\n");
      }
      if(box12Code2 != null) {
        sb.append("  box12Code2: " + gson.toJson(box12Code2) + "\n");
      }
      if(box12Code3 != null) {
        sb.append("  box12Code3: " + gson.toJson(box12Code3) + "\n");
      }
      if(box12Code4 != null) {
        sb.append("  box12Code4: " + gson.toJson(box12Code4) + "\n");
      }
      if(controlNumber != null) {
        sb.append("  controlNumber: " + gson.toJson(controlNumber) + "\n");
      }
      if(dependentCareBenefits != null) {
        sb.append("  dependentCareBenefits: " + gson.toJson(dependentCareBenefits) + "\n");
      }
      if(federalTaxWithheld != null) {
        sb.append("  federalTaxWithheld: " + gson.toJson(federalTaxWithheld) + "\n");
      }
      if(localIncomeTax != null) {
        sb.append("  localIncomeTax: " + gson.toJson(localIncomeTax) + "\n");
      }
      if(localWages != null) {
        sb.append("  localWages: " + gson.toJson(localWages) + "\n");
      }
      if(localityName != null) {
        sb.append("  localityName: " + gson.toJson(localityName) + "\n");
      }
      if(medicareTaxWithheld != null) {
        sb.append("  medicareTaxWithheld: " + gson.toJson(medicareTaxWithheld) + "\n");
      }
      if(medicareWages != null) {
        sb.append("  medicareWages: " + gson.toJson(medicareWages) + "\n");
      }
      if(nonqualifiedPlans != null) {
        sb.append("  nonqualifiedPlans: " + gson.toJson(nonqualifiedPlans) + "\n");
      }
      if(nonqualifiedPlansNonSec457 != null) {
        sb.append("  nonqualifiedPlansNonSec457: " + gson.toJson(nonqualifiedPlansNonSec457) + "\n");
      }
      if(otherAmount1 != null) {
        sb.append("  otherAmount1: " + gson.toJson(otherAmount1) + "\n");
      }
      if(otherAmount2 != null) {
        sb.append("  otherAmount2: " + gson.toJson(otherAmount2) + "\n");
      }
      if(otherAmount3 != null) {
        sb.append("  otherAmount3: " + gson.toJson(otherAmount3) + "\n");
      }
      if(otherAmount4 != null) {
        sb.append("  otherAmount4: " + gson.toJson(otherAmount4) + "\n");
      }
      if(otherCode1 != null) {
        sb.append("  otherCode1: " + gson.toJson(otherCode1) + "\n");
      }
      if(otherCode2 != null) {
        sb.append("  otherCode2: " + gson.toJson(otherCode2) + "\n");
      }
      if(otherCode3 != null) {
        sb.append("  otherCode3: " + gson.toJson(otherCode3) + "\n");
      }
      if(otherCode4 != null) {
        sb.append("  otherCode4: " + gson.toJson(otherCode4) + "\n");
      }
      ...
      if(retirementPlan != null) {
        sb.append("  retirementPlan: " + gson.toJson(retirementPlan) + "\n");
      }
      ...
      if(socialSecurityTaxWithheld != null) {
        sb.append("  socialSecurityTaxWithheld: " + gson.toJson(socialSecurityTaxWithheld) + "\n");
      }
      if(socialSecurityTips != null) {
        sb.append("  socialSecurityTips: " + gson.toJson(socialSecurityTips) + "\n");
      }
      if(socialSecurityWages != null) {
        sb.append("  socialSecurityWages: " + gson.toJson(socialSecurityWages) + "\n");
      }
      ...
      if(stateIncomeTax != null) {
        sb.append("  stateIncomeTax: " + gson.toJson(stateIncomeTax) + "\n");
      }
      if(stateWages != null) {
        sb.append("  stateWages: " + gson.toJson(stateWages) + "\n");
      }
      if(statutoryEmployee != null) {
        sb.append("  statutoryEmployee: " + gson.toJson(statutoryEmployee) + "\n");
      }
      if(tags != null) {
      ...
      if(thirdPartySickPay != null) {
        sb.append("  thirdPartySickPay: " + gson.toJson(thirdPartySickPay) + "\n");
      }
      if(uploaderId != null) {
        sb.append("  uploaderId: " + gson.toJson(uploaderId) + "\n");
      }
      if(verificationCode != null) {
        sb.append("  verificationCode: " + gson.toJson(verificationCode) + "\n");
      }
      if(wagesTipsOtherComp != null) {
        sb.append("  wagesTipsOtherComp: " + gson.toJson(wagesTipsOtherComp) + "\n");
      }
      sb.append("}\n");
      return(sb.toString());
    }
