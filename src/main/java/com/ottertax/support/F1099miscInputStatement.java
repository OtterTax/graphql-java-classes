...
public class F1099miscInputStatement {
  ...
  public String toGraphql() {
    ...
    if(cropInsuranceProceeds != null) {
      sb.append("  cropInsuranceProceeds: " + gson.toJson(cropInsuranceProceeds) + "\n");
    }
    if(excessGoldenParachute != null) {
      sb.append("  excessGoldenParachute: " + gson.toJson(excessGoldenParachute) + "\n");
    }
    ...
    if(fishPurchasedResale != null) {
      sb.append("  fishPurchasedResale: " + gson.toJson(fishPurchasedResale) + "\n");
    }
    if(fishingBoatProceeds != null) {
      sb.append("  fishingBoatProceeds: " + gson.toJson(fishingBoatProceeds) + "\n");
    }
    if(grossProceedsAttorney != null) {
      sb.append("  grossProceedsAttorney: " + gson.toJson(grossProceedsAttorney) + "\n");
    }
    if(medicalPayments != null) {
      sb.append("  medicalPayments: " + gson.toJson(medicalPayments) + "\n");
    }
    if(nonemployeeCompensation != null) {
      sb.append("  nonemployeeCompensation: " + gson.toJson(nonemployeeCompensation) + "\n");
    }
    if(nonqualDeferredComp != null) {
      sb.append("  nonqualDeferredComp: " + gson.toJson(nonqualDeferredComp) + "\n");
    }
    if(otherIncome != null) {
      sb.append("  otherIncome: " + gson.toJson(otherIncome) + "\n");
    }
    ...
    if(rents != null) {
      sb.append("  rents: " + gson.toJson(rents) + "\n");
    }
    if(royalties != null) {
      sb.append("  royalties: " + gson.toJson(royalties) + "\n");
    }
    if(section409aDeferrals != null) {
      sb.append("  section409aDeferrals: " + gson.toJson(section409aDeferrals) + "\n");
    }
    if(section409aIncome != null) {
      sb.append("  section409aIncome: " + gson.toJson(section409aIncome) + "\n");
    }
    ...
    if(substitutePayments != null) {
      sb.append("  substitutePayments: " + gson.toJson(substitutePayments) + "\n");
    }
    if(tags != null) {
