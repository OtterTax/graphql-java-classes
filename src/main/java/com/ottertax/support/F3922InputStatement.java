...
public class F3922InputStatement {
  private String accountNumber;
  private Boolean corrected;
  private Date dateOptionExercised;
  private Date dateOptionGranted;
  private Date dateTitleTransferred;
  private String exercisePpsIfOptionExercisedGrantDate;
  private String exercisePricePerShare;
  private String fmvExerciseDate;
  private String fmvGrantDate;
  ...
  public Date getDateTitleTransferred() {
    return(dateTitleTransferred);
  }
  public void setDateTitleTransferred(Date dateTitleTransferred) {
    this.dateTitleTransferred = dateTitleTransferred;
  }
  public String getExercisePpsIfOptionExercisedGrantDate() {
    return(exercisePpsIfOptionExercisedGrantDate);
  }
  public void setExercisePpsIfOptionExercisedGrantDate(String exercisePpsIfOptionExercisedGrantDate) {
    this.exercisePpsIfOptionExercisedGrantDate = exercisePpsIfOptionExercisedGrantDate;
  }
  ...
  public String getFmvExerciseDate() {
    return(fmvExerciseDate);
  }
  public void setFmvExerciseDate(String fmvExerciseDate) {
    this.fmvExerciseDate = fmvExerciseDate;
  }
  public String getFmvGrantDate() {
    return(fmvGrantDate);
  }
  public void setFmvGrantDate(String fmvGrantDate) {
    this.fmvGrantDate = fmvGrantDate;
  }
  ...
  public String toGraphql() {
    ...
    if(dateOptionExercised != null) {
      sb.append("  dateOptionExercised: " + gson.toJson(dateOptionExercised) + "\n");
    }
    if(dateOptionGranted != null) {
      sb.append("  dateOptionGranted: " + gson.toJson(dateOptionGranted) + "\n");
    }
    if(dateTitleTransferred != null) {
      sb.append("  dateTitleTransferred: " + gson.toJson(dateTitleTransferred) + "\n");
    }
    if(exercisePpsIfOptionExercisedGrantDate != null) {
      sb.append("  exercisePpsIfOptionExercisedGrantDate: " + gson.toJson(exercisePpsIfOptionExercisedGrantDate) + "\n");
    }
    if(exercisePricePerShare != null) {
      sb.append("  exercisePricePerShare: " + gson.toJson(exercisePricePerShare) + "\n");
    }
    if(fmvExerciseDate != null) {
      sb.append("  fmvExerciseDate: " + gson.toJson(fmvExerciseDate) + "\n");
    }
    if(fmvGrantDate != null) {
      sb.append("  fmvGrantDate: " + gson.toJson(fmvGrantDate) + "\n");
    }
    if(numberSharesTransferred != null) {
      sb.append("  numberSharesTransferred: " + gson.toJson(numberSharesTransferred) + "\n");
    }
