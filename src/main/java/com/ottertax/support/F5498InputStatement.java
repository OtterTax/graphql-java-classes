...
public class F5498InputStatement {
  ...
  public String toGraphql() {
    ...
    sb.append("{\n");
    if(accountFmv != null) {
      sb.append("  accountFmv: " + gson.toJson(accountFmv) + "\n");
    }
    if(accountNumber != null) {
      sb.append("  accountNumber: " + gson.toJson(accountNumber) + "\n");
    }
    if(assetAmount != null) {
      sb.append("  assetAmount: " + gson.toJson(assetAmount) + "\n");
    }
    if(assetCode != null) {
      sb.append("  assetCode: " + gson.toJson(assetCode) + "\n");
    }
    if(corrected != null) {
      sb.append("  corrected: " + gson.toJson(corrected) + "\n");
    }
    if(ira != null) {
      sb.append("  ira: " + gson.toJson(ira) + "\n");
    }
    if(iraContributions != null) {
      sb.append("  iraContributions: " + gson.toJson(iraContributions) + "\n");
    }
    if(lateContributionAmount != null) {
      sb.append("  lateContributionAmount: " + gson.toJson(lateContributionAmount) + "\n");
    }
    if(lateContributionCode != null) {
      sb.append("  lateContributionCode: " + gson.toJson(lateContributionCode) + "\n");
    }
    if(lateContributionYear != null) {
      sb.append("  lateContributionYear: " + gson.toJson(lateContributionYear) + "\n");
    }
    if(lifeInsuranceCost != null) {
      sb.append("  lifeInsuranceCost: " + gson.toJson(lifeInsuranceCost) + "\n");
    }
    if(recharacterizedContributions != null) {
      sb.append("  recharacterizedContributions: " + gson.toJson(recharacterizedContributions) + "\n");
    }
    ...
    if(repaymentAmount != null) {
      sb.append("  repaymentAmount: " + gson.toJson(repaymentAmount) + "\n");
    }
    if(repaymentCode != null) {
      sb.append("  repaymentCode: " + gson.toJson(repaymentCode) + "\n");
    }
    if(rmdAmount != null) {
      sb.append("  rmdAmount: " + gson.toJson(rmdAmount) + "\n");
    }
    if(rmdDate != null) {
      sb.append("  rmdDate: " + gson.toJson(rmdDate) + "\n");
    }
    if(rmdNextYear != null) {
      sb.append("  rmdNextYear: " + gson.toJson(rmdNextYear) + "\n");
    }
    if(rolloverContributions != null) {
      sb.append("  rolloverContributions: " + gson.toJson(rolloverContributions) + "\n");
    }
    if(roth != null) {
      sb.append("  roth: " + gson.toJson(roth) + "\n");
    }
    if(rothContributions != null) {
      sb.append("  rothContributions: " + gson.toJson(rothContributions) + "\n");
    }
    if(rothConversion != null) {
      sb.append("  rothConversion: " + gson.toJson(rothConversion) + "\n");
    }
    ...
    if(sep != null) {
      sb.append("  sep: " + gson.toJson(sep) + "\n");
    }
    if(sepContributions != null) {
      sb.append("  sepContributions: " + gson.toJson(sepContributions) + "\n");
    }
    if(simple != null) {
      sb.append("  simple: " + gson.toJson(simple) + "\n");
    }
    if(simpleContributions != null) {
      sb.append("  simpleContributions: " + gson.toJson(simpleContributions) + "\n");
    }
    if(tags != null) {
